...
from sahara.plugins.hbase import versionfactory as vhf
from sahara.plugins import provisioning as p


class HBaseProvider(p.ProvisioningPluginBase):
    def __init__(self):
        self.version_factory = vhf.VersionFactory.get_instance()

    def get_description(self):
        return _('The HBase plugin provides the ability to launch '
                 'HBase cluster based on upstream Vanilla Apache '
                 'Hadoop without any management consoles.')
