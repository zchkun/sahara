...
def get_hbasemaster(cluster):
    return u.get_instance(cluster, 'hbasemaster')


def get_regionserver(cluster):
    return u.get_instances(cluster, 'regionserver')


def get_zkserver(cluster):
