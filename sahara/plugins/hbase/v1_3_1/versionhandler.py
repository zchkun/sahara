...
from sahara.plugins.hbase import abstractversionhandler as avm
from sahara.plugins.hbase.hadoop2 import config as c
from sahara.plugins.hbase.hadoop2 import keypairs
from sahara.plugins.hbase.hadoop2 import recommendations_utils as ru
from sahara.plugins.hbase.hadoop2 import run_scripts as run
from sahara.plugins.hbase.hadoop2 import scaling as sc
from sahara.plugins.hbase.hadoop2 import starting_scripts as s_scripts
from sahara.plugins.hbase.hadoop2 import validation as vl
from sahara.plugins.hbase import utils as vu
from sahara.plugins.hbase.v1_3_1 import config_helper as c_helper
from sahara.plugins.hbase.v1_3_1 import edp_engine
...
class VersionHandler(avm.AbstractVersionHandler):
    ...
    def get_node_processes(self):
        return {
            ...
            "Hive": ["hiveserver"],
            "ZooKeeper": ["zookeeper"],
            "HBase": ["hbasemaster", "regionserver"]
        }
    ...
    def start_cluster(self, cluster):
        ...
        s_scripts.start_hbaseserver(cluster)
    ...
    def _set_cluster_info(self, cluster):
        ...
        if hm:
            info['HBase'] = {
                'Web UI': 'http://%s:%s' % (hm.management_ip, '16010')
            }
